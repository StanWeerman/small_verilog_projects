...
module fifo_np1 (clk, reset, data_in, wen, ren, data_out, depth, empty, full, fill_array);
...
output reg [(2**ADDR_WIDTH-1)-1:0] fill_array;
...
begin
    if (reset)
		begin
		    fill_array <= {((2**ADDR_WIDTH-1)-1){1'b0}};
